...
(function () {
  ...
  var FIG = {
    ...
    ohta: { n: 41, name: '太田薫', faction: 'saha', from: 1958, to: 1985,
    ...
    tomizuka: { n: 43, name: '富塚三夫', faction: 'chusa', from: 1965, to: 1993,
    ...
    wada: { n: 8, name: '和田博雄', faction: 'chuu', from: 1955, to: 1967,
      ...
      acts: [
        { name: '政策協議に応じる', desc: '政治資源 +3、自民 +8、総評 −4', cost: {}, cd: 3, uses: 3 },
    ...
    sone: { n: 10, name: '曽禰益', faction: 'uha', from: 1955, to: 1980,
      ...
      passive: '毎回、右派の不満 −2',
      acts: [
        { name: '安保の修正案を作る', desc: '政治資源 +4、総評 −6', cost: {}, cd: 3, uses: 3 },
        //  安保の条文で与党と渡り合った側である。
        { name: '自民党に回路を作る', desc: '自民 +5',
          cost: { capital: 3 }, cd: 3, uses: 3, domain: 'rel',
          fx: function (Q) { Q.ch_jimin = 1; Q.rel_jimin += 5; } }
    ...
    asukata: { n: 13, name: '飛鳥田一雄', faction: 'chusa', from: 1963, to: 1990,
      ...
      acts: [
        { name: '全国革新市長会を動かす', desc: '資金 +5、無派閥代議員 +30', cost: {}, cd: 4, uses: 2 },
    ...
    ueda: { n: 19, name: '上田哲', faction: 'saha', from: 1968, to: 1993,
      ...
      passive: '毎回、新中間層の傾向が少し上がる',
      acts: [
        { name: '街頭とテレビで押す', desc: '未組織・新中間層 +4', cost: { capital: 2 }, cd: 2, uses: 3 },
        //  革新共闘の街頭は、この人の側の仕事である。
        { name: '共産党に回路を作る', desc: '共産 +5',
          cost: { capital: 3 }, cd: 3, uses: 3, domain: 'rel',
    ...
    itoshige: { n: 21, name: '伊藤茂', faction: 'chuu', from: 1972, to: 1993,
      ...
      passive: '毎回、政治資源 +1',
      acts: [
        { name: '与野党の調整に入る', desc: '政治資源 +5、公明 +8、自民 +6', cost: {}, cd: 3, uses: 3 },
        //  国対の実務そのものである。
        { name: '自民党に回路を作る', desc: '自民 +5',
          cost: { capital: 3 }, cd: 3, uses: 3, domain: 'rel',
          fx: function (Q) { Q.ch_jimin = 1; Q.rel_jimin += 5; } }
    ...
    kuroda: { n: 27, name: '黒田寿男', faction: 'saha', from: 1955, to: 1969,
      ...
      acts: [
        { name: '日中の窓口を回す', desc: '共産 +12、自営商工 +3、農村 +2', cost: { capital: 2 }, cd: 3, uses: 3 },
